<template>
  <Layout>
    <div class="container-inner mx-auto py-16">
      ...
      >Category: {{ $page.cat.title }} has {{$page.cat.belongsTo.totalCount}} posts</h2>

      <div
        v-for="post in $page.cat.belongsTo.edges"
        :key="post.node.id"
...
export default {
  metaInfo() {
    return {
      title:
        "Category: " +
        this.$page.cat.title.charAt(0).toUpperCase() +
        this.$page.cat.title.slice(1),
      meta: [
        {
