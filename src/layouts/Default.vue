    ...
    <footer class="bg-pink-600 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-4">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:comicsghor@gmail.com" class="text-white hover:text-gray-400">
              <Gmail />
            </a>
          </li>

          <li class="mr-8">
            <a href="https://facebook.com/comicshomebd/" target="_blank" class="text-white hover:text-gray-400">
              <Facebook />
            </a>
          </li>
          ...
          <li>
            <a href="https://instagram.com/comicshomebd/" target="_blank" class="text-white hover:text-gray-400">
              <Insta />
            </a>
          </li>
        </ul>
